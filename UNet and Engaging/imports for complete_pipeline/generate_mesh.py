...
def mesh_from_voxel_grid(voxel_grid, voxel_size = 0.001):
    ...
    # ---- Step 2: Keep only largest structure ----
    ...
    # ---- Step 5: Recenter so min corner is at (0, 0, 0) in meters ----
...
if __name__ == "__main__":
    ...
    # ---- Load volume ----
    #voxel_grid = np.load(rf"voxel_grid_reconstructions\pass{pass_num}_groundtruth_reconstruction.npy")
    ...
    # ---- Save .ply file ----
    #mesh.save(f"surfaces/pass{pass_num}_groundtruth_surface.ply")
